...
Bien que sa boîte m'ait inspiré, je voulais qu'elle soit davantage axée sur le jeu magique proprement dit, et moins sur les cartes puissantes non magiques. C'est pourquoi SEULES des cartes MTG seront placées dans la boîte.

Chaque boîte de jeu a ses propres règles personnalisées, et les miennes sont les suivantes :
...
\begin{enumerate}
    ...
    \item Le deck contient un certain nombre de cartes ``joker'' (un dos de carte, Magic ou d'un autre jeu). Une carte joker NE PEUT PAS être une carte jouée lors de cette session. Cela inclut les cartes réelles ou les cartes sélectionnées avec des cartes joker précédentes. Tous les coûts associés au lancement doivent toujours être payés. Il faut évidemment connaître par cœur la carte choisie !
...
\newpage
    ...
    \item Les effets des tuteurs ont leurs propres résultats spécifiques :
    \begin{enumerate}
