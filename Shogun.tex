...
Ce format est connu en France sous le nom « Shogun » et en anglais comme « Kingdom ».\\
...
\begin{itemize}
    ...
    \item \textbf{Distribution initiale des cartes ``Shogun''} : chaque joueur reçoit une carte Shogun, aléatoirement distribuée depuis les cinq rôles disponibles.
        \begin{itemize}
            \item Si vous êtes quatre, distribuez : un Shogun, une Gardienne, deux Assassins.
...
\begin{itemize}
    ...
    \item \textbf{Rôle des Assassins} (2 max) : votre objectif est de tuer le Shogun. Vous n'êtes initialement connu de personne. Si le Shogun meurt, vous gagnez la partie (les deux Assassins peuvent gagner mutuellement).
    \item \textbf{Rôle du Traître} (2 max) : votre objectif est de tuer le Shogun, sans que les Assassins ne gagnent, donc après les avoir éliminé. Vous n'êtes initialement connu de personne. Si le Shogun perd sans que les Assassins soient encore en vie, vous gagnez la partie.
\end{itemize}
