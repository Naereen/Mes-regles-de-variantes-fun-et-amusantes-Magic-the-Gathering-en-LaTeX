...
\begin{itemize}
    ...
    \item \textbf{Rôle du Traître} (2 max) : votre objectif est de tuer le Shogun, sans que les Assassins ne gagnent, donc après les avoir éliminé. Vous n'êtes initialement connu de personne. Si le Shogun perd sans que les Assassins soient encore en vie, vous gagnez la partie. C'est évidemment le rôle le plus difficile.
\end{itemize}
