...
\subsection*{Transplaner (Changement de Plan)}

L'action de \emph{Transplaner} se produit lorsqu'une carte de Plan/Phénomène face visible est retirée et qu'une nouvelle est révélée.

\begin{enumerate}
    \item La carte de Plan ou de Phénomène active est mise au-dessous du deck planaire.
    \item Le joueur qui a provoqué l'action de \emph{Transplaner} révèle la carte du dessus du deck planaire.
...
\paragraph{Conséquences du Transplaner (Règle 901.11)}
\begin{itemize}
    \item Les effets continus dont la durée s'étend « jusqu'à ce qu'un joueur transplane » prennent fin.
    \item Les capacités qui se déclenchent « lorsqu'un joueur transplane » se déclenchent.
\end{itemize}
