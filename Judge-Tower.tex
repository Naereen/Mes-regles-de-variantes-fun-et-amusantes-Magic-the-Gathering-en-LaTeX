...
\begin{itemize}
    ...
    \item \textbf{Capacités Activées} : Vous devez activer chaque capacité activée des permanents que vous contrôlez une fois par tour et par cible légale, dès que cela est légalement possible. Activez toujours les capacités du bas de la carte vers le haut.
